...
from minihack.agent.polybeast.models import BaseNet
from minihack.agent.polybeast.models.base import NUM_CHARS
from minihack.agent.polybeast.skill_transfer.skill_transfer import load_model
